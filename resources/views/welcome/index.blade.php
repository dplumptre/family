                    ...
                    <section class="content content-boxed">
                        ...
                        <div class="row items-push-3x push-50-t nice-copy">
                            <div class="col-sm-6">
                                ...
                                <h3 class="h5 font-w600 text-uppercase text-center push-10">Welcome to Family Life Club</h3>
                                <p>Bootstrap is a sleek, intuitive, and powerful mobile first front-end framework for faster and easier web development. OneUI was built on top, extending it to a large degreBootstrap is a sleek, intuitive, and powerful mobile first front-end framework for faster and easier web development. OneUI was built on top, extending it to a large degree.</p>
                            </div>

                            <div class="col-sm-6">
         
                                <h3 class="h5 font-w600 text-uppercase text-center push-10 text-danger">Latest News</h3>
                                <p class="text-danger">OneUI will save you hundreds of hours of extra development. Bootstrap is a sleek, intuitive, and powerful mobile first front-end framework for faster and easier web development. OneUI was built on top, extending it to a large degreStart right away coding your functionality and watch your project come to life months sooner.</p>
                            </div>
                        </div>
                        ...
                        <div class="row push-20-t push-20">
                            <div class="col-sm-6 col-lg-3 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeInUp">
                                ...
                                <a class="block block-bordered block-link-hover3 text-center" href="javascript:void(0)">
                                    ...
                                    <div class="block-content block-content-full bg-gray-lighter">
                                        <div class="h1 font-w700 push-10">&#8358;5,000</div>
                            ...
                            <div class="col-sm-6 col-lg-3 visibility-hidden" data-toggle="appear" data-offset="50" data-timeout="200" data-class="animated fadeInUp">
                                ...
                                <a class="block block-bordered block-link-hover3 text-center" href="frontend_signup.html">
                                    ...
                                    <div class="block-content block-content-full bg-gray-lighter">
                                        <div class="h1 font-w700 text-primary push-10"> &#8358;10,000</div>
                                        <div class="h5 font-w300 text-muted">per month</div>
                                    </div>
                                    <div class="block-content">
                                        <table class="table table-borderless table-condensed">
                            ...
                            <div class="col-sm-6 col-lg-3 visibility-hidden" data-toggle="appear" data-offset="50" data-timeout="400" data-class="animated fadeInUp">
                                ...
                                <a class="block block-bordered block-link-hover3 text-center" href="javascript:void(0)">
                                    ...
                                    <div class="block-content block-content-full bg-gray-lighter">
                                        <div class="h1 font-w700 push-10">&#8358;20,000</div>
                                        <div class="h5 font-w300 text-muted">per month</div>
                                    </div>
                                    <div class="block-content">
                                        <table class="table table-borderless table-condensed">
                    ...
                    <div class="bg-primary-dark-op">
                        <section class="content content-full content-boxed">
                            ...
                            <div class="row items-push-2x push-50-t text-center">
								...
								<h3 style='color:#ffffff;padding-bottom:20px'>TESTIMONIALS</h3>
