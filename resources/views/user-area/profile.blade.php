                            ...
                            <form>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input class="form-control input-lg" disabled="" type="email" id="profile-email"
                                               name="profile-email" placeholder="Enter your email.."
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input class="form-control input-lg" type="text" id="profile-firstname"
                                               name="profile-firstname" placeholder="Enter your firstname.."
                                               value="John">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control input-lg" type="text" id="profile-city"
                                               name="profile-city" value="0819089928474">
                                    </div>
                                </div>


                                <button class="btn btn-sm btn-primary" type="submit"><i
                                            class="fa fa-check push-5-r"></i> Save Changes
                                </button>
                            ...
                            <form>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input class="form-control input-lg" type="password" id="profile-password"
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input class="form-control input-lg" type="password" id="profile-password-new"
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input class="form-control input-lg" type="password"
                                               id="profile-password-new-confirm" name="profile-password-new-confirm">
                                    </div>
                                </div>

                                <button class="btn btn-sm btn-primary" type="submit"><i
                                            class="fa fa-check push-5-r"></i> Save Password
                                </button>
                            </form>
                        </div>
                    </div>
